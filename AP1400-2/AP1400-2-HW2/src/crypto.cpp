...
bool crypto::RSASign(RSA* rsa, const unsigned char* Msg, size_t MsgLen,
...
bool crypto::RSAVerifySignature(RSA* rsa, unsigned char* MsgHash,
                                size_t MsgHashLen, const char* Msg,
...
void crypto::Base64Encode(const unsigned char* buffer, size_t length,
                          char** base64Text) {
    BIO *bio, *b64;
    BUF_MEM* bufferPtr;
...
void crypto::Base64Decode(const char* b64message, unsigned char** buffer,
                          size_t* length) {
    BIO *bio, *b64;
...
bool crypto::verifySignature(std::string publicKey, std::string plainText,
                             std::string signatureBase64) {
    RSA* publicRSA = createPublicRSA(publicKey);
    unsigned char* encMessage;
    size_t encMessageLength;
    bool authentic;
    Base64Decode((char*)signatureBase64.c_str(), &encMessage,
                 &encMessageLength);
    bool result =
